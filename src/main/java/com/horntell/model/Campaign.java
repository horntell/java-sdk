...
public class Campaign {
    ...
    public static HorntellResponse toProfiles(String[] profiles, String campaignId, Map<String, Object> meta) throws IOException, InvalidRequestException, AuthenticationException, ForbiddenException, NotFoundException, ServiceException, HorntellException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("meta", meta);
